...
public class DigitalVideoDisc extends Disc implements Playable{
	...
	@Override
	public void print() {
		System.out.printf("Type: %-10sID: %-5dTitle: %-34sCategory: %-20sCost: %10.2f$%n", "DVD", this.getId(), this.getTitle(),this.getCategory(),this.getCost());
		System.out.printf("%16sDirector: %-40sLength: %-2d'%n","",this.getDirector(),this.getLength());
	}
